OC.L10N.register(
    ...
    "A pad on another Etherpad server cannot be used as a template.": "Un pad hébergé sur un autre serveur Etherpad ne peut pas servir de modèle.",
    "A template must be a .pad file.": "Un modèle doit être un fichier .pad.",
    "A template of that name already exists.": "Un modèle portant ce nom existe déjà.",
    "API key accepted": "Clé API acceptée",
    "API version {version}": "Version de l’API {version}",
    ...
    "Address of the pad on the other server, for example https://pad.example.org/p/notes": "Adresse du pad sur l'autre serveur, par exemple https://pad.example.org/p/notes",
    "Admin permissions required.": "Permissions administrateur requises.",
    "All checks passed.": "Toutes les vérifications ont réussi.",
    "Allow importing protected pads from legacy Ownpad files": "Autoriser l'import des pads protégés depuis les anciens fichiers Ownpad",
    ...
    "Check finished. Some settings need attention.": "Vérification terminée. Certains réglages demandent votre attention.",
    "Check pending pads": "Vérifier les pads en attente",
    "Checking for the original pad...": "Recherche du pad d’origine...",
    "Checks that Nextcloud reaches the Etherpad API with the values above.": "Vérifie que Nextcloud atteint l'API Etherpad avec les valeurs ci-dessus.",
    ...
    "Could not delete the template.": "Le modèle n'a pas pu être supprimé.",
    ...
    "Could not load the pad content.": "Impossible de charger le contenu du pad.",
    ...
    "Could not read the templates.": "Les modèles n'ont pas pu être lus.",
    ...
    "Could not save the template.": "Le modèle n'a pas pu être enregistré.",
    ...
    "Etherpad cannot be reached right now. Try again later.": "Etherpad est injoignable pour le moment. Réessayez plus tard.",
    ...
    "Etherpad is currently unavailable for this shared pad.": "Etherpad est actuellement indisponible pour ce pad partagé.",
    "Etherpad refused the request. Please contact your administrator.": "Etherpad a refusé la demande. Veuillez contacter votre administration.",
    "Etherpad refused to open this shared pad. Please contact the share owner.": "Etherpad a refusé d'ouvrir ce pad partagé. Contactez la personne qui l'a partagé.",
    ...
    "Invalid accessMode. Use public or protected.": "accessMode non valide. Utilisez public ou protected.",
    ...
    "Invalid parentFolderId.": "parentFolderId non valide.",
    "Loading pad content...": "Chargement du contenu du pad…",
    ...
    "Pad binding is inconsistent. Please contact the share owner.": "Le lien du pad est incohérent. Contactez la personne qui l'a partagé.",
    "Pad creation failed.": "Une erreur s'est produite lors de la création du pad.",
    "Pad file is temporarily locked. Please retry.": "Le fichier .pad est temporairement verrouillé. Réessayez.",
    ...
    "Pending pad check failed.": "La vérification des pads en attente a échoué.",
    "Pending pad check finished.": "Vérification des pads en attente terminée.",
    ...
    "Safe only where this Nextcloud alone creates group pads on your Etherpad server. Anywhere else, a hand-written .pad file can reach another group while this is on.": "Sûr uniquement si ce Nextcloud est le seul à créer des pads de groupe sur votre serveur Etherpad. Partout ailleurs, un fichier .pad écrit à la main peut atteindre un autre groupe tant que cette option est activée.",
    ...
    "Shared pad templates": "Modèles de pad partagés",
    ...
    "Template file is empty.": "Le fichier de modèle est vide.",
    "Template file is too large.": "Le fichier de modèle est trop volumineux.",
    "Template file not found.": "Fichier modèle introuvable.",
    "Template name is required.": "Un nom de modèle est requis.",
    "Template name is too long.": "Le nom du modèle est trop long.",
    "Template name must not contain a path.": "Le nom du modèle ne doit pas contenir de chemin.",
    "Template request failed.": "La requête sur les modèles a échoué.",
    "Template saved.": "Modèle enregistré.",
    "Templates offered to everyone when creating a pad. Upload a .pad file: its content becomes the new pad, and placeholders such as {{date}} are resolved on creation. The pad type of the template is used when that type is enabled; otherwise the pad is created with the type that is available, which can turn a protected template into a public pad.": "Modèles proposés à tout le monde lors de la création d'un pad. Téléversez un fichier .pad : son contenu devient le nouveau pad et les espaces réservés tels que {{date}} sont résolus à la création. Le type de pad du modèle est utilisé si ce type est activé ; sinon le pad est créé avec le type disponible, ce qui peut transformer un modèle protégé en pad public.",
    ...
    "That file name is not allowed on this server.": "Ce nom de fichier n'est pas autorisé sur ce serveur.",
    ...
    "The file changed while its pad was being set up. Try again.": "Le fichier a changé pendant la configuration de son pad. Réessayez.",
    "The pad this file links to on another server could not be read.": "Le pad d'un autre serveur vers lequel pointe ce fichier n'a pas pu être lu.",
    "The selected .pad file has an invalid format.": "Le fichier .pad sélectionné a un format non valide.",
    "The selected .pad file is missing required metadata.": "Il manque des métadonnées requises dans le fichier .pad sélectionné.",
    "The selected file is not part of this share.": "Le fichier sélectionné ne fait pas partie de ce partage.",
    "The selected item is not a .pad document.": "L'élément sélectionné n'est pas un document .pad.",
    ...
    "This .pad file and its pad could not be matched. Try again, or contact your administrator if it keeps happening.": "Ce fichier .pad et son pad ne correspondent pas. Réessayez, ou contactez votre administration si le problème persiste.",
    "This .pad file has no matching pad in this Nextcloud.": "Ce fichier .pad n'a pas de pad correspondant dans ce Nextcloud.",
    "This .pad file has no pad in this Nextcloud. Its owner can open it to restore the pad.": "Ce fichier .pad n'a pas de pad dans ce Nextcloud. Son propriétaire peut l'ouvrir pour restaurer le pad.",
    "This .pad file has no pad metadata yet.": "Ce fichier .pad n'a pas encore de métadonnées de pad.",
    "This .pad file is already linked to a pad.": "Ce fichier .pad est déjà lié à un pad.",
    "This file is a legacy Ownpad link to a protected pad, and importing those is disabled on this server. Please contact your administrator.": "Ce fichier est un ancien lien Ownpad vers un pad protégé et l'importation de ces pads est désactivée sur ce serveur. Veuillez contacter votre administration.",
    ...
    "This legacy Ownpad file names a pad that does not exist in Etherpad.": "Cet ancien fichier Ownpad désigne un pad qui n'existe pas dans Etherpad.",
    "This link does not point to a valid file.": "Ce lien ne pointe pas vers un fichier valide.",
    "This pad is already linked to another file you do not have access to.": "Ce pad est déjà lié à un autre fichier auquel vous n'avez pas accès.",
    "This pad is still being restored. Try again later.": "Ce pad est encore en cours de restauration. Réessayez plus tard.",
    "This pad is still empty.": "Ce pad est encore vide.",
    "This pad is too large to show here. Open it in Etherpad instead.": "Ce pad est trop volumineux pour être affiché ici. Ouvrez-le dans Etherpad.",
    "This pad type is disabled on this instance.": "Ce type de pad est désactivé sur cette instance.",
    "This share link does not allow reading files.": "Ce lien de partage ne permet pas de lire des fichiers.",
    "This share link is invalid or has expired.": "Ce lien de partage n'est pas valide ou a expiré.",
    "This shared item is no longer available.": "Cet élément partagé n'est plus disponible.",
    "Trusted embed origins (optional)": "Origines d'intégration de confiance (optionnel)",
    "Try again": "Réessayer",
    "Unknown error.": "Erreur inconnue.",
    "Unresolved restores": "Restaurations non résolues",
    "Unsupported test fault.": "Défaut de test non pris en charge.",
    "Upload template": "Téléverser un modèle",
    "Uploading template...": "Téléversement du modèle…",
    ...
    "{domain} would cover both.": "{domain} couvrirait les deux.",
    ...
    "{url} was not contacted: Nextcloud blocks requests into its own network. Check that your users' browsers can reach this address.": "{url} n'a pas été contactée : Nextcloud bloque les requêtes vers son propre réseau. Vérifiez que les navigateurs de vos utilisateurs peuvent atteindre cette adresse."
},
