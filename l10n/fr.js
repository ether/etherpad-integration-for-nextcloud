OC.L10N.register(
    ...
    "They share no parent domain, so Nextcloud cannot set a session cookie that reaches Etherpad, and protected pads will not open. If a proxy already serves Etherpad under the Nextcloud domain, enter that address as the base URL — pad links use it, so the cookie follows. Otherwise move one of the hosts, or switch protected pads off.": "Ils ne partagent aucun domaine parent : Nextcloud ne peut donc pas définir de cookie de session qui atteigne Etherpad, et les pads protégés ne s'ouvriront pas. Si un proxy sert déjà Etherpad sous le domaine Nextcloud, saisissez cette adresse comme URL de base : les liens de pad l'utilisent, le cookie suivra donc. Sinon, déplacez l'un des hôtes ou désactivez les pads protégés.",
