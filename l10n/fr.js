OC.L10N.register(
    ...
    "A legacy Ownpad .pad file names the Etherpad pad it opens, and for a protected pad that name also picks an Etherpad group – opening it grants access to everything in that group. Switch this on only while migrating, and only if this Nextcloud is the only thing creating group pads on your Etherpad server: a genuine Ownpad pad cannot be told apart from someone else's. Public pads are imported either way.": "Un ancien fichier .pad Ownpad désigne le pad Etherpad qu'il ouvre et, pour un pad protégé, ce nom choisit aussi un groupe Etherpad : l'ouvrir donne accès à tout ce que contient ce groupe. N'activez cette option que pendant une migration, et uniquement si ce Nextcloud est la seule chose qui crée des pads de groupe sur votre serveur Etherpad : un véritable pad Ownpad ne peut pas être distingué de celui de quelqu'un d'autre. Les pads publics sont importés dans tous les cas.",
    ...
    "Import protected pads from legacy Ownpad files": "Importer les pads protégés depuis les anciens fichiers Ownpad",
