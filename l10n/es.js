OC.L10N.register(
    ...
    "A legacy Ownpad .pad file names the Etherpad pad it opens, and for a protected pad that name also picks an Etherpad group – opening it grants access to everything in that group. Switch this on only while migrating, and only if this Nextcloud is the only thing creating group pads on your Etherpad server: a genuine Ownpad pad cannot be told apart from someone else's. Public pads are imported either way.": "Un archivo .pad heredado de Ownpad indica el pad de Etherpad que abre y, en el caso de un pad protegido, ese nombre también selecciona un grupo de Etherpad: quien lo abre obtiene acceso a todo lo que contiene ese grupo. Actívalo solo durante una migración y solo si esta Nextcloud es lo único que crea pads de grupo en tu servidor Etherpad: un pad auténtico de Ownpad no se puede distinguir del de otra persona. Los pads públicos se importan de todos modos.",
    ...
    "Import protected pads from legacy Ownpad files": "Importar pads protegidos desde archivos heredados de Ownpad",
