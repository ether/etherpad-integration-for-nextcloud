OC.L10N.register(
    ...
    "They share no parent domain, so Nextcloud cannot set a session cookie that reaches Etherpad, and protected pads will not open. Move one of them to a shared domain, or switch protected pads off.": "No comparten ningún dominio principal, por lo que Nextcloud no puede establecer una cookie de sesión que llegue a Etherpad y los pads protegidos no se abrirán. Mueve uno de los dos a un dominio compartido o desactiva los pads protegidos.",
