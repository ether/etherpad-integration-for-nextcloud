OC.L10N.register(
    ...
    "Allow importing protected pads from legacy Ownpad files": "Permitir importar pads protegidos desde archivos heredados de Ownpad",
    ...
    "Check pending pads": "Comprobar pads pendientes",
    ...
    "Etherpad cannot be reached right now. Try again later.": "No se puede acceder a Etherpad en este momento. Vuelve a intentarlo más tarde.",
    ...
    "Etherpad is currently unavailable for this shared pad.": "Etherpad no está disponible en este momento para este pad compartido.",
    "Etherpad refused the request. Please contact your administrator.": "Etherpad rechazó la solicitud. Ponte en contacto con tu administración.",
    "Etherpad refused to open this shared pad. Please contact the share owner.": "Etherpad se negó a abrir este pad compartido. Ponte en contacto con quien lo ha compartido.",
    ...
    "Invalid accessMode. Use public or protected.": "accessMode no válido. Usa public o protected.",
    ...
    "Invalid parentFolderId.": "parentFolderId no válido.",
    ...
    "Pad binding is inconsistent. Please contact the share owner.": "El vínculo del pad es incoherente. Ponte en contacto con quien lo ha compartido.",
    "Pad creation failed.": "Se produjo un error al crear el pad.",
    "Pad file is temporarily locked. Please retry.": "El archivo .pad está bloqueado temporalmente. Vuelve a intentarlo.",
    ...
    "Safe only where this Nextcloud alone creates group pads on your Etherpad server. Anywhere else, a hand-written .pad file can reach another group while this is on.": "Solo es seguro si esta Nextcloud es la única que crea pads de grupo en tu servidor Etherpad. En cualquier otro caso, un archivo .pad escrito a mano puede alcanzar otro grupo mientras esto esté activado.",
    ...
    "The file changed while its pad was being set up. Try again.": "El archivo cambió mientras se configuraba su pad. Vuelve a intentarlo.",
    "The pad this file links to on another server could not be read.": "No se pudo leer el pad de otro servidor al que enlaza este archivo.",
    "The selected .pad file has an invalid format.": "El archivo .pad seleccionado tiene un formato no válido.",
    "The selected .pad file is missing required metadata.": "Al archivo .pad seleccionado le faltan metadatos obligatorios.",
    "The selected file is not part of this share.": "El archivo seleccionado no forma parte de este recurso compartido.",
    "The selected item is not a .pad document.": "El elemento seleccionado no es un documento .pad.",
    ...
    "This .pad file and its pad could not be matched. Try again, or contact your administrator if it keeps happening.": "No se pudo asociar este archivo .pad con su pad. Vuelve a intentarlo o, si sigue ocurriendo, ponte en contacto con tu administración.",
    ...
    "This .pad file has no pad in this Nextcloud. Its owner can open it to restore the pad.": "Este archivo .pad no tiene ningún pad en este Nextcloud. Su propietario puede abrirlo para restaurar el pad.",
    "This .pad file has no pad metadata yet.": "Este archivo .pad aún no tiene metadatos de pad.",
    "This .pad file is already linked to a pad.": "Este archivo .pad ya está vinculado a un pad.",
    "This file is a legacy Ownpad link to a protected pad, and importing those is disabled on this server. Please contact your administrator.": "Este archivo es un enlace heredado de Ownpad a un pad protegido y su importación está desactivada en este servidor. Ponte en contacto con tu administración.",
    ...
    "This legacy Ownpad file names a pad that does not exist in Etherpad.": "Este archivo heredado de Ownpad hace referencia a un pad que no existe en Etherpad.",
    "This link does not point to a valid file.": "Este enlace no apunta a un archivo válido.",
    "This pad is already linked to another file you do not have access to.": "Este pad ya está vinculado a otro archivo al que no tienes acceso.",
    "This pad is still being restored. Try again later.": "Este pad todavía se está restaurando. Vuelve a intentarlo más tarde.",
    "This pad is still empty.": "Este pad todavía está vacío.",
    "This pad is too large to show here. Open it in Etherpad instead.": "Este pad es demasiado grande para mostrarlo aquí. Ábrelo en Etherpad.",
    "This pad type is disabled on this instance.": "Este tipo de pad está desactivado en esta instancia.",
    "This share link does not allow reading files.": "Este enlace compartido no permite leer archivos.",
    "This share link is invalid or has expired.": "Este enlace compartido no es válido o ha caducado.",
    "This shared item is no longer available.": "Este elemento compartido ya no está disponible.",
    "Trusted embed origins (optional)": "Orígenes de incrustación de confianza (opcional)",
    "Try again": "Intentar de nuevo",
    "Unknown error.": "Error desconocido.",
    "Unresolved restores": "Restauraciones sin resolver",
