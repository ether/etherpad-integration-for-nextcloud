OC.L10N.register(
    ...
    "A legacy Ownpad .pad file names the Etherpad pad it opens, and for a protected pad that name also picks an Etherpad group – opening it grants access to everything in that group. Switch this on only while migrating, and only if this Nextcloud is the only thing creating group pads on your Etherpad server: a genuine Ownpad pad cannot be told apart from someone else's. Public pads are imported either way.": "Eine alte Ownpad-.pad-Datei benennt das Etherpad-Pad, das sie öffnet, und bei einem geschützten Pad wählt dieser Name zugleich eine Etherpad-Gruppe – wer es öffnet, erhält Zugriff auf alles in dieser Gruppe. Schalte dies nur während einer Migration ein, und nur wenn diese Nextcloud das Einzige ist, was auf deinem Etherpad-Server Gruppen-Pads anlegt: Ein echtes Ownpad-Pad lässt sich nicht von dem einer anderen Person unterscheiden. Öffentliche Pads werden ohnehin importiert.",
    ...
    "Import protected pads from legacy Ownpad files": "Geschützte Pads aus alten Ownpad-Dateien importieren",
