OC.L10N.register(
    ...
    "Same as the API URL, already covered above.": "Identisch mit der API-URL, oben bereits geprüft.",
    ...
    "They share no parent domain, so Nextcloud cannot set a session cookie that reaches Etherpad, and protected pads will not open. Move one of them to a shared domain, or switch protected pads off.": "Sie haben keine gemeinsame übergeordnete Domain. Nextcloud kann deshalb kein Sitzungscookie setzen, das Etherpad erreicht, und geschützte Pads lassen sich nicht öffnen. Verschiebe einen der beiden auf eine gemeinsame Domain oder schalte geschützte Pads ab.",
