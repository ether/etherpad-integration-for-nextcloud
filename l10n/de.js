OC.L10N.register(
    ...
    "No base URL configured.": "Keine Basis-URL konfiguriert.",
    ...
    "Same as the API URL, already checked.": "Identisch mit der API-URL, bereits geprüft.",
    ...
    "They share no parent domain, so Nextcloud cannot set a session cookie that reaches Etherpad, and protected pads will not open. If a proxy already serves Etherpad under the Nextcloud domain, enter that address as the base URL — pad links use it, so the cookie follows. Otherwise move one of the hosts, or switch protected pads off.": "Sie haben keine gemeinsame übergeordnete Domain. Nextcloud kann deshalb kein Sitzungscookie setzen, das Etherpad erreicht, und geschützte Pads lassen sich nicht öffnen. Wenn ein Proxy Etherpad bereits unter der Nextcloud-Domain ausliefert, trage diese Adresse als Basis-URL ein – die Pad-Links verwenden sie, das Cookie folgt also. Andernfalls verschiebe einen der Hosts oder schalte geschützte Pads ab.",
