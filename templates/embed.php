...
<div id="etherpad-nextcloud-embed"
	...
	data-l10n-readonly-title="<?php p((string)($_['l10n']['readonly_title'] ?? 'Read-only view')); ?>"
	data-l10n-content-message="<?php p((string)($_['l10n']['content_message'] ?? 'Loaded when you opened this pad.')); ?>"
