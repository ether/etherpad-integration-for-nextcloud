...
/** Another request made the file's row first; the next open finds its pad. */
export const LOST_RACE = { message: 'This .pad file and its pad could not be matched. Try again, or contact your administrator if it keeps happening.', retryable: true }
