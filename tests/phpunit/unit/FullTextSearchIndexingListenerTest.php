...
class FullTextSearchIndexingListenerTest extends TestCase {
	...
	public function testLeavesTemporarilyUnreadablePadsUnindexed(\Throwable $error): void {
	...
	private function listener(?PadFileService $service = null): FullTextSearchIndexingListener {
		return new FullTextSearchIndexingListener($service ?? new PadFileService(new FixedClock()));
	}
