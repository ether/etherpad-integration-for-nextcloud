...
export FULLTEXTSEARCH="${FULLTEXTSEARCH:-0}"
export ELASTICSEARCH_VERSION="${ELASTICSEARCH_VERSION:-8.19.21}"
readonly FULLTEXTSEARCH_VERSION=34.0.1
readonly FILES_FULLTEXTSEARCH_VERSION=34.0.1
readonly FULLTEXTSEARCH_ELASTICSEARCH_VERSION=34.0.1
readonly FULLTEXTSEARCH_SHA256=8f681b691bdf739b6a54f76c3e6a04ae2978756e59cb5e29433445e8f7ce11f6
...
if [[ "$FULLTEXTSEARCH" == 1 && "$NC_VERSION" != 34 ]]; then
	echo "The optional full-text-search stack currently supports NC_VERSION=34 only." >&2
	exit 1
fi
...
if [[ "$FULLTEXTSEARCH" == 1 ]]; then
	echo "Search      Elasticsearch ${ELASTICSEARCH_VERSION} (run index-fulltextsearch.sh after changing a pad)"
fi
echo
