 ...
 * in none of them (BindingService::TEAM_TRASH_PATH).
 */
enum FileLocation {
	...
	case InUserTrash;
	/** Anywhere else - in Files, or a team folder's trash with a storage of its own (BindingService::TEAM_TRASH_PATH). */
	case Elsewhere;
}
